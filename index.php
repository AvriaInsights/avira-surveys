                        ...
                        <div class="">
                            ...
                            <ul class="list-unstyled d-flex top-list align-items-center mb-0 mob-menu">
                                ...
                                <li class="nav-item dropdown nav-menu2" id="survey-list">
                                  ...
                                  <ul class="dropdown-menu pt-0 pb-0" aria-labelledby="navbarDropdown">
                                    <li class="p-0">
...
<section class="d-flex align-items-center justify-content-center ptb position-relative">
    <div class="container">
        <div class="row">
            <div class="col-md-12 aos-init aos-animate" data-aos="fade-right" data-aos-delay="300">
        ...
        <div class="row desktop-ind">
            ...
            <div class="col-md-3 aos-init aos-animate" data-aos="fade-left" data-aos-delay="400">

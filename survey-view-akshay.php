...
$surveyid="538b47cb-7d18-474a-8994-a80b6260e373";
/**********All Questions***************/
$fields_questions = "*";
                            ...
                            <div class="col-lg-8 offset-lg-2 col-md-10 que_section offset-md-1" id="divQstn">
                             ...
                             ?>
                			   ...
                			   <?php if ($all_question['quest_type_id'] == "6") { ?> 
                		        ...
                		        <?php if ($all_question['quest_type_id'] == "9") { ?>
				                 <div id="que_<?php echo $srno;?>" style="display:none" class="que_scroll item mt-1 checkbox-scroll-vt" data-id='<?php echo $srno;?>' isAttempted="0">
                                   <div class="align-txt">
                                        <h4>Question <span id="displayqno_<?php echo $srno;?>"></span> <sup id="star_<?php echo $srno;?>" class="fs-3 star" style="display:none">*</sup></h4>
                                         <?php if($all_question['tooltip']!=""){?>
                                     ...
                                     <input type="hidden" name="skip_to_<?php echo $all_question['question_id'];?>" id="skip_to_<?php echo $all_question['question_id'];?>" value="<?php echo $all_question['skip_question_where_to'];?>">
                                       <div class="chk_class">
                                        ...
                                        <?php }?>
            				                        ...
            				                        <?php $counter = 0; foreach($all_subpoints as $all_subpoint){ $counter++; ?>
                                                     <div class="col-md-10">
                                                          <input id="mrating_<?php echo $all_subpoint['question_subid'];?>" type="checkbox" name="mrating" value='<?php echo stripslashes(str_replace("'", '"', $all_subpoint['question_subtitle']));?>' onchange="SetAttempted(this,<?php echo $all_question['sequence'];?>,<?php echo $all_question['question_id'];?>,<?php echo $srno;?>)" <?php if($all_subpoint['question_subtitle']=="Other"){?> onclick="showmratingtextbox(<?php echo $all_question['question_id'];?>,<?php echo $all_subpoint['question_subid'];?>);setmratingquestans(<?php echo $srno;?>,<?php echo $all_subpoint['question_subid'];?>,<?php echo $all_question['question_id'];?>,this.value);" <?php } else  {?> onclick="setmratingquestans(<?php echo $srno;?>,<?php echo $all_subpoint['question_subid'];?>,<?php echo $all_question['question_id'];?>,this.value);" <?php }?>>
                                                            <label for="mrating<?php echo $all_subpoint['question_subid'];?>">
                                                                <span class="float-start text-dark span" id="<?php echo $all_subpoint['question_subid'];?>"><?php echo $counter; ?></span> &nbsp; 
                                                                <p class="survey-txt"><?php echo stripslashes($all_subpoint['question_subtitle']);?></p>
                                                            </label>
                                                     </div>
                                                     <?php if($all_question['mrating_range'] == "1_to_10"){ ?>
                                                     <div class="col-md-2">
                                                         <select class="form-control mrating_ropdown">
                                                     ...
                                                     <?php }  ?>
                                                      <?php if($all_question['mrating_range'] == "1_to_5"){ ?>
                                                     <div class="col-md-2">
                                                         <select class="form-control mrating_ropdown">
                                                             <option>-Select Rating-</option>
                                                             <?php
                                                     ...
                                                     <?php }  } ?>
                                                     <input type="hidden" value="<?php echo count($all_subpoints);?>" id="chk_sub_count" name="chk_sub_count">
                                                    <div class="" style="display:none" id="mrating_other_text_field_<?php echo $all_question['question_id'];?>">
                            						   <div class="form__group field">
                                                         <input type="text" class="form__field effect-2" autocomplete = "off" placeholder="Please Enter Your Response" name="mrating_other_text_<?php echo $all_question['question_id'];?>" id='mrating_other_text_<?php echo $all_question['question_id'];?>' value="" onkeyup="activenextbutton(<?php echo $srno;?>,<?php echo $all_question['question_id'];?>)"/>
                                                       </div>
                                                    </div> 
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-12 mt-2 mb-4">
                                                            <div class="button next-btn-q" id="btn_next_mrating" onclick="setnext(<?php echo $srno;?>,<?php echo $all_subpoint['question_subid'];?>,<?php echo $all_question['question_id'];?>,'');">
                                                             <div id="slide" class="slide"></div>
                		        ...
                		        <?php if ($all_question['quest_type_id'] == "10") { ?>
				                 <div id="que_<?php echo $srno;?>" class="que_scroll item mt-1 checkbox-scroll-vt" data-id='<?php echo $srno;?>' isAttempted="0">
                                   <div class="align-txt">
                                        <h4>Question <span id="displayqno_<?php echo $srno;?>"></span> <sup id="star_<?php echo $srno;?>" class="fs-3 star" style="display:none">*</sup></h4>
                                         <?php if($all_question['tooltip']!=""){?>
                                                 <div class="tooltip"><span data-tooltip="<?php echo $all_question['tooltip']; ?>" data-tooltip-position="left">
                                       ...
                                       <div class="chk_class matrix_tbl">
                                        <table class="responsive-table-input-matrix matrix_tbl">
                                           ...
                                           <?php  
                                            ...
                                            $condition_subpoints_count = "`tbl_questionSub`.`question_id` =".$all_question['question_id']." and `tbl_questionSub`.`matrix_type` ='row'";
                                            $all_subpoints_matrix=$obj_survey->getSubQuestionPoints($fields_subpoints_count, $condition_subpoints_count, '', '', 0); 
                                            ?>
                                                <tr>
                                                    <td></td>
                                                    <?php
                                                     $fields_subpoints_count_clm = "*";
                                                     $condition_subpoints_count_clm = "`tbl_questionSub`.`question_id` =".$all_question['question_id']." and `tbl_questionSub`.`matrix_type` ='column'";
                                                     $all_subpoints_matrix_clm=$obj_survey->getSubQuestionPoints($fields_subpoints_count_clm, $condition_subpoints_count_clm, '', '', 0); 
                                                     $count_coulmn = count($all_subpoints_matrix_clm);
                                                    
                                                     foreach($all_subpoints_matrix_clm as $all_subpoints_matrix_clms){
                                                    ?>
                                                    <td><?php echo $all_subpoints_matrix_clms['question_subtitle']; ?></td>
                                                    <?php } ?>
                                        		</tr>
                                                
                                                <?php foreach($all_subpoints_matrix as $all_subpoints_matrixs){ ?>
                                        		<tr class="matrix_checkbox">
                                        			<td><?php if($all_subpoints_matrixs['matrix_type']=="row"){ echo $all_subpoints_matrixs['question_subtitle']; } ?></td>
                                        			<?php for($j=1;$j<=$count_coulmn;$j++) { ?>
                                        			    <td><input type="<?php if($all_question['matrix_input_type']=="checkbox"){ echo "checkbox"; } else {echo "radio";}?>" name="matrixchk_<?php echo $j; ?>"></td>
                                        			 <?php } ?>
                                        		</tr>
                                        		<?php } ?>
                                        		</tbody>
...
function showmratingtextbox(qid,subid)
{
    var ischecked = $('#mrating_'+subid).prop('checked');
    var mratingotherval = $('#mrating_'+subid).val();
    if(mratingotherval=="Other" && ischecked==true)
    {
      $("#mrating_other_text_field_"+qid).show();
    }
    else
    {
        $("#mrating_other_text_field_"+qid).hide();
    }
}
   ...
   // alert(attemptedCount);
        ...
        // End Horizantal Progress        
            ...
            function setorderval(currsrno)
            {
                  ...
                  $("#list_"+lstqstid).sortable({update: function() {
...
$(document).ready(function(){
        ...
        $(document).load($(window).bind("resize", checkPosition()));
            ...
            $("input:radio[name=matrixchk]").click(function() {
               var el = $(this);
               var col = el.data("col");

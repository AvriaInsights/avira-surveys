    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header text-primary"><i class="fa fa-th-list"></i> Manage FAQ List</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <!--<div class="panel-heading">
                                <span class="pull-left">General Category List</span>
                            ...
                            <div>
                                ...
                                <div class="panel-body">
                                    <div class="dataTable_wrapper">
                                        <div>
                                            <table id="category-data" class="table table-striped table-bordered table-hover" width="100%" cellspacing="0">
                                                <thead>
                                                    <tr>
                                                        <th># ID</th>
                                                        <th>Question</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Import Category Lists</h4>
                </div>
                <div class="modal-body">
                    <form id="import-form" action="import-category-action.php" enctype="multipart/form-data" method="post">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#category-data').dataTable({
                "bProcessing": true,
                "sAjaxSource": "load-faq.php?report_id=<?php echo $_GET['report_id'];?>",
                "aoColumns": [
                    {mData: 'faq_id'},
                    {mData: 'question'},
                    {mData: 'answer'},

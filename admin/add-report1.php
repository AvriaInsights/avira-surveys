                                        ...
                                        <div class="col-lg-12">
                                            <form role="form" method="POST" action="add-report-action.php" enctype="multipart/form-data" name="add-form" id="add-form">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control tinymce" name="description" id="description" placeholder="Description"><?php echo (isset($report_detail['description'])) ? $report_detail['description'] : ""; ?></textarea>
                                                </div>

                                                <div class="form-group">
                                                    <label>Table of Content </label>
                                                    <textarea class="form-control tinymce" name="toc" id="toc" placeholder="Table of Content"><?php echo (isset($report_detail['toc'])) ? $report_detail['toc'] : ""; ?></textarea>
                                                </div>

                                                <div class="form-group">
                                                    <label>Tables and Figures </label>
                                                    <textarea class="form-control tinymce" name="tnf" id="tnf" placeholder="Table of Content"><?php echo (isset($report_detail['tnf'])) ? $report_detail['tnf'] : ""; ?></textarea>
                                                </div>

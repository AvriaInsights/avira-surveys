...
function sendReportMail($subject, $message) {
    ...
    //   $mail->AddBCC("Mangesh.kanase@inforgrowth.com");
    //   $mail->AddBCC("nitish.pande@inforgrowth.com");
    //   $mail->AddBCC("suraj.ukarde@inforgrowth.com");
    //     $mail->AddBCC("aslam.khan@inforgrowth.com");
    //$mail->AddCC("debasmita.sain@inforgrowth.com");
...
function sendContactMail($subject, $message) {
    ...
    #BCC Email Address
      // $mail->AddBCC("rohan.s@inforgrowth.com");
     //  $mail->AddBCC("viswanath.g@inforgrowth.com");
       $mail->AddBCC("leads@inforgrowth.com");
       $mail->AddBCC("farhan.s@avirainsights.com");
    //   $mail->AddBCC("Mangesh.kanase@inforgrowth.com");
    //   $mail->AddBCC("leads@in4research.com");
    //   // $mail->AddBCC("nikunj.a@inforgrowth.com");
    //   $mail->AddBCC("nitish.pande@inforgrowth.com");
    //   // $mail->AddBCC("suraj.ukarde@inforgrowth.com");
    //     $mail->AddBCC("aslam.khan@inforgrowth.com");
    //   $mail->AddBCC("vinod.khandare@inforgrowth.com");
    //  //  $mail->AddBCC("reuben.fernandes@alltheresearch.com");
    //  $mail->AddBCC("amrita.prasad@12thwonder.com");
...
function sendCareersMail($subject, $message, $file_tmp, $file_name) {
    ...
    //   $mail->AddBCC("leads@inforgrowth.com");
    //   $mail->AddBCC("Mangesh.kanase@inforgrowth.com");
      // $mail->AddBCC("susneha@avirainsights.com");
      // $mail->AddBCC("nikunj.a@inforgrowth.com");
    //   $mail->AddBCC("nitish.pande@inforgrowth.com");
     //  $mail->AddBCC("suraj.ukarde@inforgrowth.com");
    //   $mail->AddBCC("vinod.khandare@inforgrowth.com");
...
function sendReportMailCampaignDataCenter($subject, $message) {
   ...
   $mail->AddBCC("farhan.s@avirainsights.com");
    ...
    //   $mail->AddBCC("emelia@inforgrowth.com");
...
function sendReportMailCampaigncyber($subject, $message) {
   ...
   #BCC Email Address
    ...
    //   $mail->AddBCC("sumedh@leadsinfra.com");
    //   $mail->AddBCC("emelia@inforgrowth.com");
    //   $mail->AddBCC("ritesh.kurjekar@inforgrowth.com");
    //   $mail->AddBCC("masood@leadsinfra.com");
    //   $mail->AddBCC("vinod.khandare@inforgrowth.com");
    //  $mail->AddBCC("reuben.fernandes@alltheresearch.com");

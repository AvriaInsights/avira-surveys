    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header text-primary"><i class="fa fa-th-list"></i> Manage Topic List</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <span class="pull-left">General Topic List</span>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#topic-data').dataTable({
                "bProcessing": true,
                "sAjaxSource": "load-topic.php",
                "aoColumns": [
                    {mData: 'bundle_id'},
                    {mData: 'bundle_name'},
                    {mData: 'bundle_overview'},
                    {mData: 'market_data'},
                    {mData: 'status'}

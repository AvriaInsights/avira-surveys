...
{
$fields_survey_check = "*";
$condition_survey_check = "`tbl_survey`.`survey_id` = '".$surveyid."'";
$all_surveys_details_check = $obj_survey->getSurveyDetail($fields_survey_check, $condition_survey_check, '', '', 0);
foreach($all_surveys_details_check as $all_surveys_details_checks)
{
    $survey_status = $all_surveys_details_checks['survey_status'];
}
if($survey_status == "Unpublished")
{
   require_once 'unpublished-survey.php';
   exit;
}
}
?>
                        ...
                        <div class="">
                            ...
                            <ul class="list-unstyled d-flex top-list align-items-center mb-0 mob-menu">
                                ...
                                <li class="nav-menu2 first-menu" id="survey-list">
                                    <a href="<?php echo SITEPATHFRONT; ?>news">News</a>
                                </li>
                                
                               <li class="nav-item dropdown nav-menu2" id="survey-list">
                                  ...
                                  <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li class="p-0">
                                        <a href="<?php echo SITEPATHFRONT; ?>survey-list">Surveys</a>
                                    </li>
                                    <li class="p-0">
                                ...
                                <!--<li class="nav-menu2" id="survey-list">-->

        ...
        <div class="container">
            <div class="row mt-5 mb-5">
                ...
                <div class="col-md-6 offset-md-3">
                    <div class="text-center mt-3 mb-3 p-3" id="text-page">
                        <img src="<?php echo SITEPATHFRONT;?>images/unpublished_survey.png" alt="Avira Surveys" class="w-100">
                    </div>
                </div>
                <!-- /.col-md-12 -->
                <div class="col-md-12">

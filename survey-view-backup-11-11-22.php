                    ...
                    if(keycode == '13')
                    {
                        ...
                        if(fname_error_message === false && email_error_message === false && phone_error_message === false)
                        {
                            $.ajax({
                				...
                				type: "POST",
                				data: {url_source:url_source,phone:phoneno,allquestionids:allquestionids,allanswers:allanswers,fname:fname,email:email,surveyid:"<?php echo $surveyid?>",userid:<?php echo $user_id?>,sessipaddrlastform:sessipaddrlastform},
                				cache: false,
                				beforeSend: function(){
            ...
            $("#lastsubmit").click(function(){
                ...
                <?php if(isset($_GET['name']) && isset($_GET['email'])){?>
                      $.ajax({
                				url: "<?php echo SITEPATHFRONT; ?>survey-view-action.php",
                				type: "POST",
                				data: {url_source:url_source,allquestionids:allquestionids,allanswers:allanswers,fname:fname,email:email,surveyid:"<?php echo $surveyid?>",userid:<?php echo $user_id?>,sessipaddrlastform:sessipaddrlastform,sessfirstform:'<?php echo $_SESSION['campaign_user_id'];?>'},
                				cache: false,
                				beforeSend: function(){
                                    // Show image container
                                    $('#span_loader').show();
                ...
                <?php } else {?>
                    <?php if($_SESSION['response_user_id']==""){?>
                        ...
                        if(fname_error_message === false && email_error_message === false && phone_error_message === false)
                        {
                            $.ajax({
                				url: "<?php echo SITEPATHFRONT; ?>survey-view-action.php",
                				type: "POST",
                				data: {url_source:url_source,phone:phoneno,allquestionids:allquestionids,allanswers:allanswers,fname:fname,email:email,surveyid:"<?php echo $surveyid?>",userid:<?php echo $user_id?>,sessipaddrlastform:sessipaddrlastform,sessfirstform:'<?php echo $_SESSION['response_user_id'];?>'},
                				cache: false,
                				beforeSend: function(){
                                    // Show image container
                                    $('#span_loader').show();
                    ...
                    if(fname=="" && email=="")
                    {
                       ...
                       $.ajax({
                				url: "<?php echo SITEPATHFRONT; ?>survey-view-action.php",
                				type: "POST",
                				data: {url_source:url_source,allquestionids:allquestionids,allanswers:allanswers,fname:fname,email:email,surveyid:"<?php echo $surveyid?>",userid:<?php echo $user_id?>,sessipaddrlastform:sessipaddrlastform,sessfirstform:'<?php echo $_SESSION['response_user_id'];?>'},
                				cache: false,
                				beforeSend: function(){
                                    // Show image container
                                    $('#span_loader').show();

   ...
   //alert(subtitle);
     ...
     //alert(seq);
        ...
        else
        {
            ...
            // for(var tt=0; tt<allsubidsplit.length; tt++)
            // {
                        
            //     var leftoptionvalue=$("#order_"+allsubidsplit[tt]+" option:selected").val();
            //     if(leftoptionvalue!="")
            //     {
            ...
            // }
                ...
                else
                {
                    ...
                    for(var ttt=0; ttt<allsubidsplit.length; ttt++)
                    {
                        ...
                        // }
                        // alert(setoptselval);
                         // var posq123 = setoptselval.indexOf(arrpop);
                         //alert(posq123);
                        //alert(flag);
                        //alert(setoptselval);
                        ...
                        {
                            //alert(arrpop);
                            var opt1 = $("#order_"+allsubidsplit[ttt]+" option[value='" + arrpop + "']").prop('disabled', false); 

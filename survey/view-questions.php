    	   ...
    	   /////////////////////////////////
            $.ajax({
                    ...
                    success: function(data2){//{"qtitle":"what is your favourate game.?","qtooltip":"","qrequired":"No"}
                        ...
                        //alert(data2.qdynamic);
                        if(data2.qdynamic=="Dynamic")
                        { 
                           $("#dynamic-"+qt).prop('checked', true); 
                        }
                        else
                        {
                                ...
                                if(allmratingvalue.length > 0)
                                {
                                    ...
                                    { 
                                        ...
                                        if(mratingval[4] != "percentage"){
                                            ...
                                            else if(mratingval[3]=="1_to_20")
                                            {
                                                $("#mrating_scale").show();
                                                $("#mrating-percentage").hide();
                                                $("#range-1-20-mrating").prop('checked', true);
                                            }
                                            else if(mratingval[3]=="1_to_10")
                                            {
                                                $("#mrating_scale").show();
                                                $("#mrating-percentage").hide();
                                                $("#range-1-10-mrating").prop('checked', true);
                                            }
                                            else if(mratingval[3]=="")
                                            {
                                                $("#mrating_scale").hide();
                                                $("#mrating-percentage").hide();
                                            }
                                       }
                                       else if(mratingval[4] == "percentage")
                                        {
                                            if(mratingval[3]=="1_to_20")
                                            {
                                                $("#mrating_scale").show();
                                                $("#mrating-percentage").show();
                                                $("#range-1-20-mrating").prop('checked', true);
                                            }
                                            else if(mratingval[3]=="1_to_5")
                                             {
                                                 $("#mrating_scale").show();
                                                  $("#mrating-percentage").show();
                                                 $("#range-1-5-mrating").prop('checked', true);
                                        ...
                                        //$('#mrating_option_type option[value='mratingval[4]']').attr('selected','selected');
                                        $(`#mrating_option_type option[value='${mratingval[4]}']`).prop('selected', true);
                                    }
                                } 
                        ...
                        { 
                              ...
                              var matrix_input_type=data2.matrix_input_type;
                              $("#mattype").val(matrix_input_type);
                                ...
                                var allmatrixvalue = data2.qsubtitle;
                                ...
                                if(allmatsplit1.length > 0)
                                {
                                 ...
                                 for(var y=0;y<matcolarray.length;y++)
                                 {
                                     ...
                                     resultstring+= '<td class="tabbord"><input class="form-control formsize" placeholder="' + matcol[0] + '" type="text" value="" name="" id="rowcol'+matcol[1]+'" style="text-align:center;background-color:#F5F5F5;" onkeyup="changematname('+matcol[1]+')"></td>';
                                ...
                                {  
                                    ...
                                    resultstring+= '<tr class="tabbord">';
                                    resultstring+= '<td class="tabbord"><input class="form-control formsize" placeholder="' + matrow[0] + '" type="text" value="" name="" id="rowcol'+matrow[1]+'" style="text-align:center;" onkeyup="changematname('+matrow[1]+')"></td>';
                                    for(var y=0;y<matcolarray.length;y++)
                                    {
                                        resultstring+= '<td class="tabbord" style="text-align:center;"><div id="setmatrixtype'+x+y+'"><input type='+matrix_input_type+' disabled></div></td>';
                                    }
                                    resultstring+= '</tr>';
                                }

    ...
    <div class="row">
      ...
      <div id="demo3"></div>
        ...
        <div class="col-md-3 mt-9">
            <div class="">
                            <a href="template-list.php" class="fs-4 text-bold text-black">
                        ...
                        <div class="bg-white box-shadow p-4 br-25 mt-3">
                            ...
                            <div class="view-button-template">
                                <a class="btn btn-primary p-2 fs-3" href="add-survey?templateid=<?php echo base64_decode($_GET['id']); ?>">Choose Template &nbsp;&nbsp;<i class="fa fa-check-circle"></i></a>
                            </div>
   ...
   //var qseq=$("#qsequence").val();
        if(qtypename=="Radio")
        {
            ...
            {  
               ...
               var rad_other_value1 = $("#radio_other_text_"+qid).val().trim();
            ...
            if(allvaluesset.length > 0)
            {
                ...
                { 
                    if(allvaluesset[iii].includes("Other"))
                    {
                        ...
                        var check_other_value = check_other_value1.replace(",","");

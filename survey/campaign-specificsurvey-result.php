    ...
    <div class="modal-content" style="max-height:80%!important;">
      ...
      <div class="modal-body" style="height:250px;padding-top:50px;">
          ...
          <div class="col-md-12 text-center" style="padding-top:40px;">
              <a href="javascript:void(0);" id="export-all-filter" class="view-survey-btn" download="" style="font-size:14px;"><i class="fa fa-download fa-1x"></i> Export User List</a><img class="survey-loader" style="width:3rem !important;" src="<?php echo SITEPATH; ?>images/loading-survey.gif">
          </div>
	...
	$(document).ready(function() {
		...
		$("#export-all-filter").click(function(){
		    ...
		    if(daterror == 0 && daterror1 == 0)
		    {
		      ...
		      //  $.ajax({
        // 				url: "<?php echo SITEPATH; ?>export-campaign-result-by-user.php",
        // 				type: "GET",
        // 				data: {
        // 					surveyid:survid,daterange:daterange
        // 				},
        // 				cache: false,
        // 				beforeSend: function() {
        //                     $('#export-all-filter').addClass("exportbutton");
		      //              $(".survey-loader").show();
		      //              //window.location="<?php echo SITEPATH;?>export-campaign-result-by-user.php?surveyid="+survid+"&daterange="+daterange;
        //                 },
        ...
        //                     {
        //                         $(".survey-loader").hide();
        // 				        $('#export-all-filter').removeClass("exportbutton");
        //                     }
        // 				}
		      //  });
		    }

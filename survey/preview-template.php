...
if(isset($_GET['id'])){
    ...
    foreach ($template_details as $template_detail) {
          ...
          $template_description=$template_detail['template_description'];
    }
}else{
...
$orderby="`tbl_dummy_questionBank`.`sequence` ASC";
$all_questions=$obj_template->getDummyQuestions($fields_questions, $condition_questions, $orderby, '', 0);
?>
...
#overlayer_f{display:none !important;}
html {
...
.matrix_tbl tr td:last-child {border-right:none !important;}
.matrix_tble th:last-child{border-right:none !important;}
...
<link rel="stylesheet" href="<?php echo SITEPATH;?>css/template.css">
    ...
    <div class="row">
                           ...
                           <div class="row">
                            ...
                            <div class="col-lg-8 offset-lg-2 col-md-10 que_section offset-md-1" id="divQstn">
                              ...
                              <?php $srno=1;foreach ($all_questions as $all_question) { 
                                    ...
                                    $fields_subpoints = "*";
                                    $condition_subpoints = "`tbl_dummy_subQuestion`.`question_id` =".$all_question['question_id'];
                                    $all_subpoints=$obj_template->getSubQuestion($fields_subpoints, $condition_subpoints, '', '', 0);
                                            ...
                                            <div class="chk_class matrix_tbl">
                                                <table class="responsive-table-input-matrix matrix_tbl">
                                                    <tbody>
                                                        ...
                                                        $condition_subpoints_count = "`tbl_dummy_subQuestion`.`question_id` =".$all_question['question_id'];
                                                        $all_subpoints_matrixs=$obj_survey->getDummySubQuestionPoint($fields_subpoints_count, $condition_subpoints_count, '', '', 0); 
                                                        ?>
                                                            <tr>
                                                                <td></td>
                                                                <?php
                            ...
                            <div class="row">
                                    <div class="col-md-12 text-center mt-5 mb-5 p-3" id="temp_section">
                                       <h1 class="text-white first_survey_heading"><strong><?php echo $template_name;?></strong></h1>
                                       <h3 class="text-white survey-ttl-data"><?php echo $template_description;?></h3>
                                                     ...
                                                     <div class="row d-flex justify-content-end">
                                                         <div class="col-lg-8 col-md-6">
                                                              <div class="text-right cmp_logo_text">
                                                                ...
                                                                <p><img class="logo-dash img-fluid" src="<?php echo SITEPATHFRONT; ?>images/logo-dark.png"></p>
                                                              </div>
                                                         </div>
      ...
      <div id="demo3"></div>
        ...
        <div class="col-md-3 mt-9">
            <div class="">
                            <a href="<?php echo SITEPATH; ?>template-list" class="fs-4 text-bold text-black">
                                <i class="fa fa-arrow-left" aria-hidden="true"></i> 
                                 back to template
                            </a>
                        </div>
                        <div class="bg-white box-shadow p-4 br-25 mt-3">
                            <div class="back-cursor">
                                <h4 class="pb-4"><strong><?php echo $template_name;?></strong></h4>
                                <p class="temp_desc p-3"><?php echo $template_description;?></p>
                            </div>
                            <div class="view-button-template">
                                <a class="btn btn-primary p-2 fs-3" href="<?php echo SITEPATH; ?>add-survey?templateid=<?php echo base64_decode($_GET['id']); ?>">Choose Template &nbsp;&nbsp;<i class="fa fa-check-circle"></i></a>
                            </div>
                            <div class="view-button-template text-center mt-20">
                                <span>Have your own ideas in mind?</span>
                                <span class="d-block"></span>
                                <a class="" href="<?php echo SITEPATH;?>add-survey">
                                    Start Blank Survey <i class="fa fa-arrow-circle-right"></i></a>
                                    <span class="d-block"></span>
                                <img src="<?php echo SITEPATH; ?>/images/rocket.png" class="card-img-temp pt-4" alt="rocket">
                            </div>
                        </div>
        </div>
    </div>
...
function setmultipleratingquestans(title,curqno,subid,qid,ans)
{
    ...
    {     if(mratingcounter<mratingcnt)
          ...
          if(splitratval.length==mratingcnt || mratingcounter==mratingcnt)
          {
...
function checksequence(subqueid,qid)
{
    ...
    if(seq == '')
    {
        ...
        $('#rating_error_message_'+qid).html("Select all Rating Options");
    }
    else
    {
        ...
        $(document).load($(window).bind("resize", checkPosition()));
            function checkPosition()
            {
                ...
                if($(window).width()==320){
                    ...
                    if(checkbox_scroll >= 4)
                    {
                    // alert(checkbox_scroll);   
                        $('.sub_points_down_chk').attr('style', 'height: 200px !important; overflow-y: scroll');
                    }
                    if(ranking_scroll >= 5)
                    {
                        $('.sub_points_down').attr('style', 'height: 250px !important; overflow-y: scroll');

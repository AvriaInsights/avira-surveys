...
foreach($question_bank_lists as $question_bank_list)
{
    ...
    $arr['qdynamic'] = $question_bank_list['is_dynamic'];
    ...
    elseif($qtype=="Mrating")
    {
        $malloption.=stripslashes($question_bank_list['question_subtitle']).":".$question_bank_list['question_subid'].":".$question_bank_list['question_id'].":".$question_bank_list['mrating_range'].":".$question_bank_list['mrating_option_type']."*";
    }
    elseif($qtype=="Matrix")
    {
        $arr['matrix_input_type'] = $question_bank_list['matrix_input_type'];

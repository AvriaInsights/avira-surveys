                      ...
                      <div class="column1 colpad">
                           <?php if(isset($_GET['surveyid'])){?><h2 class="card-title cardt"><?php echo $survey_title;?></h2><?php }?>
                            ...
                            <div class="row leftsubbox">
                                <div class="col-md-12">
                                    <div class="icon-wrapper"><i class="fa fa-plus add-icon-plus" aria-hidden="true" id="addnewquestion"></i><span class="padquesttext1">Add Question</span></div><p></p>
                                </div>
                            </div>
                      </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body create-survey-modal">
                ...
                <form id="request-form" action="<?php echo SITEPATH; ?>add-survey-title-action.php" method="post">
                    <div class="form-group">
                        <input type="text" class="form-control" name="surveytitle" id="surveytitle" placeholder="Survey Title">
                    </div>
                    ...
                    <div class="form-group popupmar">
                        <textarea class="form-control message-box-ht" id="description" name="description" placeholder="Survey Description" style="height:83px;"></textarea>
                    </div>

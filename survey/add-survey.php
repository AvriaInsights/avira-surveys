...
.tabbord{ border: 1px solid #DCDCDC;}
.matrixtable1{ width:98%;
    margin: 0px auto;
}
</style>
...
<div class="wrapper">
   <?php include("sidebarmenu.php")?>
        ...
        <section class="space-padding-top add-survey-back">
            <div class="container-fluid pse-2">
                <div class="row">
                    <div class="col-md-4">
                        
                        <div class="bg-white p-4 br-5 box-shadow result-scroll" id="style-7">
                            ...
                            <div id="ques_img" class="survey_img_empty">
                             ...
                             <div id="allquestiontype">
                                    ...
                                    <?php $allquestiontype="";foreach($question_type_list as $question_type_lists){ 
                                      if( $question_type_lists['quest_type'] != "Dropdown") {
                                    ?>
                                          <div class="col-md-4 paddqtype1" style="cursor:pointer;" onclick="fetchquesttype('<?php echo $question_type_lists['quest_type'];?>','<?php echo $question_type_lists['quest_type_id'];?>')">
                                            <img class="qtype_icon" src="<?php echo SITEPATH; ?>images/qtype_icon/<?php echo $question_type_lists['quest_type']; ?>.png"> <span class="questyp" id="questyp<?php echo $question_type_lists['quest_type_id'];?>"><?php if($question_type_lists['quest_type'] == "Order"){ echo "Rank Order";} elseif($question_type_lists['quest_type'] == "Mrating"){ echo "Multiple Rating";} else { echo $question_type_lists['quest_type']; } ?></span>
                                            ...
                                            <form class="row">
                                                <div class="questionbox">
                                                   <div class="col-md-12">
                                                    ...
                                                    <div id="showmratingquestionoptions"></div>
                                                ...
                                                <div class="tabbox">
                                              	    <div class="tabset">
                                                          ...
                                                          <div class="tab-panels" id="text" style="display:none;">
                                                           ...
                                                           <div class="tab-panels" id="checkbox" style="display:none;">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <!--  <div class="main-holder">-->
                                                                        <!--        <div class="form-group reqflt">-->
                                                                        <!--           <input type="checkbox" class="largerCheckbox" name="dynamic-checkbox" id="dynamic-checkbox">-->
                                                                        <!--           <label class="form-label checklabel">Dynamic</label>-->
                                                                        <!--        </div>-->
                                                                        <!--  </div>-->
                                                                        <!--</div>-->
                                                                    </div>
                                                          ...
                                                          <!--Rank Order Button-->
                                                            ...
                                                            <!--Multiple Rating Button-->
                                                                 <div class="tab-panels" id="mrating" style="display:none;">
                                                                    <section id="options" class="tab-panel">
                                                                    <div class="row">
                                                                        <div class="col-md-8">
                                                                          <div class="main-holder">
                                                                                <div class="form-group">
                                                                                   <input type="text" class="form-control formsize" name="questiontooltip-mrating" id="questiontooltip-mrating" placeholder="Tooltip">
                                                                                </div>
                                                                          </div>
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                         <!-- <div class="main-holder">
                                                                                <div class="form-group reqflt">
                                                                                   <input type="checkbox" class="largerCheckbox" name="other-mrating" id="other-mrating">
                                                                                   <label class="form-label checklabel">Other</label>
                                                                                </div>
                                                                            </div>-->
                                                                        </div>
                                                                        <div class="col-md-2">
                                                                          <div class="main-holder">
                                                                                <div class="form-group reqflt">
                                                                                   <input type="checkbox" class="largerCheckbox" name="isrequired-mrating" id="isrequired-mrating">
                                                                                   <label class="form-label checklabel">Required</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                         <div class="col-md-4">
                                                                                <div class="form-group float-start mt-3 font-weight-normal">
                                                                                   <p class="fs-4">Select Multiple Rating Type : </p>
                                                                                </div>
                                                                            </div>
                                                                             <div class="col-md-6">
                                                                                <div class="form-group float-start">
                                                                                   <select class="form-select formsize" id="mrating_option_type" name="mrating_option_type">
                                                                                       <option value="">Select Option</option>
                                                                                       <option value="scale">Scale (ex - [1,2,3,....,10])</option>
                                                                                       <option value="range">Range (ex - [1 to 5] / [1 to 10]</option>
                                                                                       <option value="percentage">Percentage (ex - [0-5%] / [0-10%] / [0-20%])</option>
                                                                                       <option value="textbox">Textbox (Enter Number)</option>
                                                                                   </select>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-12">
                                                                                <div class="star" id="mratingtype_error_message_mrating"></div>
                                                                            </div>
                                                                    </div>
                                                                    <div class="row pt-1" id="mrating_scale" style="display:none">
                                                                         <div class="col-md-3">
                                                                                <div class="form-group float-start mt-3 font-weight-normal">
                                                                                   <p class="fs-4">Rating Option : </p>
                                                                                </div>
                                                                            </div>
                                                                          <div class="col-md-2">
                                                                                <div class="form-group float-start">
                                                                                   <input type="radio" class="" name="mrating-range" id="range-1-10-mrating" value="1_to_10" checked>
                                                                                   <label class="form-label txt-bold">1 to 10</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-1">
                                                                            <label class="form-label txt-bold">OR</label>
                                                                            </div>
                                                                         <div class="col-md-2">
                                                                                <div class="form-group float-start">
                                                                                   <input type="radio" class="" name="mrating-range" value="1_to_5" id="range-1-5-mrating">
                                                                                   <label class="form-label txt-bold">1 to 5</label>
                                                                                </div>
                                                                            </div>
                                                                        <div class="col-md-3" id="mrating-percentage" style="display:none">
                                                                            <div class="d-flex">
                                                                                <div class="col-md-1">
                                                                                    <label class="form-label txt-bold">OR</label>
                                                                                </div>
                                                                                <div class="col-md-10">
                                                                                    <div class="form-group float-start">
                                                                                       <input type="radio" class="" name="mrating-range" value="1_to_20" id="range-1-20-mrating">
                                                                                       <label class="form-label txt-bold">1 to 20</label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        </div>
                                                                    <form name="add_mrating_name" id="add_mrating_name">
                                                                    <div class="table-responsive">  
                                                                        <table class="table table-bordered table-qtype" id="dynamic_field_mrating">  
                                                                            <tr>  
                                                                                <td><input type="text" name="mratingname[]" id="mratingname1" placeholder="Enter Choice" class="form-control name_list chkboxtxt" onkeyup="showmratingoption('1')"/></td>  
                                                                                <td><button type="button" name="addmarating" id="addmrating" class="btn add-icon-plus-options">+</button></td>  
                                                                            </tr> 
                                                                        </table> 
                                                                        <div class="star" id="questionsubtitle_error_message_mrating"></div>
                                                                    </div>
                                                                    </form>
                                                                    <div class="row"><div class="col-md-12"><hr></div></div>
                                                                    </section>
                                                                    <section id="logic" class="tab-panel">
                                                                           <div class="row">
                                                                                <div class="col-md-12">
                                                                                   <div class="main-holder">
                                                                                       <div class="row" style="text-align:center;" id="logicquestions-mrating">
                                                            ...
                                                            <section id="logic" class="tab-panel">
                                                                <div class="container">
                                                                   <div class="row">
                                                                        <div class="col-md-12">
                                                                           <div class="main-holder">
                                                                               <div class="row" style="text-align:center;" id="logicquestions-matrix">
                                                                               </div> 
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row mt-5">
                                                                  ...
                                                                  <input type="hidden" name="textdynamic" id="textdynamic" value="">
          ...
          <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                ...
                <form id="request-form" class="create-survey-module" action="<?php echo SITEPATH; ?>add-survey-title-action.php" method="post">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control formsize" name="campaign_name" id="campaign_name" placeholder="Campaign Name">
                    </div>
                    <br>
                    <div class="form-group">
                        <input type="text" class="form-control formsize" name="survey_purpose" id="survey_purpose" placeholder="Survey Objective">
                    </div>
                    <!--<br>-->
                    <!--<div class="form-group">-->
                    ...
                    <!--        <option value="Intent/Information">Intent/Information</option>-->
                    <!--    </select>-->
                    <!--</div>-->
                    <br>
                    <div class="form-group">
                    ...
                    <div class="form-group popupmar">
                     ...
                     <div class="form-group popupmar">
                        <label><h5>Position of User Deatil Form</h5></label>
                         <fieldset id="group1">
                            <input type="radio" value="First" name="user_form_position" id="user_form_position_first" class="formsize message-box-ht">
                            <label for="user_form_position_first" class="rdo_label">Starting of Survey</label>&nbsp;
                            <input type="radio" value="Last" name="user_form_position" id="user_form_position_last" class="formsize message-box-ht" checked="checked">
...
<script type="text/javascript">
 ...
 $(document).ready(function () {
     // ==== loader ======//
        ...
        var mratingtype_error_message_mrating = false;
        ...
        $("#mratingname1").keyup(function(){
           var qsubtitle= $("#mratingname1").val();
           var qsubtitle = qsubtitle.trim();
            if(qsubtitle == '')
            {
                $("#questionsubtitle_error_message_mrating").show();
                $("#questionsubtitle_error_message_mrating").html("Please enter Rating Options");
                questionsubtitle_error_message = true;
            }
            else
            {
                $("#questionsubtitle_error_message_mrating").hide();
                questionsubtitle_error_message = false;
            } 
        });
        ...
        $("#editcurrentquestion").click(function(){
            ...
            questiontitle_error_message = false;
            matrix_error_message = false;
            martingtype_error_message = false;
            questionsubtitle_error_message = false;
            check_questiontitle();
            var editnumItems = "";
            var addnumItems = "";
             ...
             if(currentqtypecheck == "dropdown")
             {
              ...
              if(currentqtypecheck == "mrating")
             {
                 $("#mratingtype_error_message_mrating").show();
                 $("#questionsubtitle_error_message_mrating").show();
                 var editnumItems = $('#showmratingquestionoptions').children('div').length;
                 var addnumItems = $("#showmratingquestionoptions").children('div').length;
                 var mrating_option_type = $("#mrating_option_type").val();
                 if(editnumItems != 0 || addnumItems != 0)
                      {
                         $('#questionsubtitle_error_message_mrating').html(" ");
                         questionsubtitle_error_message = false;
                      }
                      else
                      {
                      ...
                      if(mrating_option_type != "")
                      {
                         $('#mratingtype_error_message_mrating').html(" ");
                         martingtype_error_message = false;
                      }
                      else
                      {
                          $('#mratingtype_error_message_mrating').html("Please Select Option Type");
                          martingtype_error_message = true;
            ...
            if(questiontitle_error_message === false && questionsubtitle_error_message === false && matrix_error_message === false && martingtype_error_message === false)
            {
                var i=1;
                ...
                if(currentqtype=="checkbox")
                {
                    if ($("#dynamic-"+currentqtype).is(":checked") == true) 
                    {
                        $('#textdynamic').val('Dynamic');
                    } 
                    else 
                    {
                        $('#textdynamic').val('');
                    }
                    var dynamicchk = $('#textdynamic').val();
                }
                else
                {
                    var dynamicchk = "";
                ...
                var mratingoptions = $("input[name='mratingname[]']").map(function(){return $(this).val().trim();}).get();
                var mratingoptiontype = $("#mrating_option_type").val();
                if(currentqtype == "mrating")
                {
                var mrating_range = $('input:radio[name="mrating-range"]:checked').val();
                }
                else{
                   var mrating_range = ""; 
                }
                ...
                //alert(radoptions);
                 if(frmaction=="Insert")
                 {
                    ...
                    if(mratingoptions==""){mratingoptions="";}
                    if(mratingoptiontype==""){mratingoptiontype="";}
                ...
                $.ajax({
                      ...
                      success: function(dataquestion){
                            ...
                            $("#middlelabel").val("");
                            $("#rightlabel").val("");
                             $('#mrating_option_type').prop('selectedIndex',0);
       ...
       var i=1;
        ...
        $(document).on('click', '.btn_remove_rank', function(){
         ...
         //Add options for Multiple Rating
        $('#addmrating').click(function(){
           i++;  
           //alert(i);
           $('#dynamic_field_mrating').append('<tr id="row'+i+'" class="dynamic-addedmrating"><td><input type="text" id="mratingname'+i+'" name="mratingname[]" placeholder="Enter Choice" class="form-control name_list chkboxtxt" onkeyup="showmratingoption('+i+')" /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove_mrating">X</button></td></tr>');  
        });
        
        $(document).on('click', '.btn_remove_mrating', function(){
            
           var button_id = $(this).attr("id"); 
           $('#row'+button_id+'').remove(); 
           $("#txxmrating" + button_id).remove();
        }); 
        
         $("#other-mrating").click(function () {
            
            $("#showmratingquestionoptions").show();
            
    	    if ($("#other-mrating").is(":checked") == true)
    	    {
                $('#textother').val('Other');
                var optmrating = $("#textother").val();
                var mratingoptions = $("#textother").val();
                
                $("#showmratingquestionoptions").append('<div class="col-md-12" name="txxmrating'+optmrating+'" id="txxmrating'+optmrating+'"><div class="row"><div class="col-md-12"><div class="main-holder" style="font-size:17px;"><input type="radio" id="radiotype'+optmrating+'"disabled><span style="padding-left:10px;" id="radiorep'+optmrating+'">'+mratingoptions+'</span></div></div></div></div>');
                
            } else {
                // $('#textrequired').val('No');
                $("#textother").val('');
                $("#txxmratingOther").remove();
            }
        });
        ...
        for(var jj=0;jj<valNew.length;jj++)
        {
         ...
         else
         {
                                ...
                                $.ajax({
                                        ...
                                        //alert("hello");
                                          //  alert(data32.qsubtitle);
                                                ...
                                                var resultstring='<table class="matrixtable1">';
                                                if(allmatsplit1.length > 0)
                                                {
                                                 ...
                                                 resultstring+= '<tr class="tabbord">';
                                                 resultstring+= '<td class="tabbord"></td>';
                                                 for(var y=0;y<matcolarray.length;y++)
                                                 {
                                                     var matcol = matcolarray[y].split("*");
                                                     resultstring+= '<td class="tabbord"><input class="form-control formsize matrix-tbl-input" placeholder="'+matcol[0]+'" type="text" value="" name="" id="rowcol'+matcol[1]+'"  onkeyup="changematname('+matcol[1]+')"></td>';
                                                ...
                                                {  
                                                    ...
                                                    resultstring+= '<tr class="tabbord">';
                                                    resultstring+= '<td class="tabbord"><input class="form-control formsize matrix-tbl-input" placeholder="'+matrow[0]+'" type="text" value="" name="" id="rowcol'+matrow[1]+'"  onkeyup="changematname('+matrow[1]+')"></td>';
                                                    for(var y=0;y<matcolarray.length;y++)
                                                    {
                                                        resultstring+= '<td class="tabbord"><div id="setmatrixtype'+x+y+'"></div></td>';
                                                    }
                                                    resultstring+= '</tr>';
                                                }
          ...
          if(qtype12=="Boolean")
          {
            ...
            $("#showquestionoptions").html('<div class="row justify-content-center"><div class="col-2 yesno_box__icon-wrap"><i class="icon-like"></i></div><div class="col-2 yesno_box__icon-wrap" style="margin-left:10px;"><i class="icon-dislike" ></i></div></div><div class="row justify-content-center"><div class="col-2 bollab"><label>YES</label></div><div class="col-2 bollab" style="margin-left:10px;"><label>NO</label></div></div>');
            $("#questiontitle").val("");
            $("#questiontooltip-"+qt).val("");
            $('#isrequired-'+qt).prop('checked', false);
             $("#dynamic-"+qt).prop('checked', false);
    ...
    function showmratingoption(optmrating)
	{  
	    $("#showmratingquestionoptions").show();
	    var mratingoptions = $("#mratingname"+optmrating).val();
        
        var myDiv4 = $('#txxmrating'+optmrating);
       
        if(myDiv4.length)
        {
	        $("#mratingrep"+optmrating).text(mratingoptions);
	        if($("#mratingrep"+optmrating).text()=="")
	        {
	            
	            $("#mratingtype"+optmrating).hide();
	        }
	        else
	        {
	            $("#mratingtype"+optmrating).show();
	        }
        }
        else
        {
           
            $("#showmratingquestionoptions").append('<div class="col-md-12" name="txxmrating'+optmrating+'" id="txxmrating'+optmrating+'"><div class="row"><div class="col-md-12"><div class="main-holder" style="font-size:17px;"><input type="radio" id="mratingtype'+optmrating+'"disabled><span style="padding-left:10px;" id="mratingrep'+optmrating+'">'+mratingoptions+'</span></div></div></div></div>');
        }
                                        ...
                                        //alert("hkeel");
                                           // alert(data32.qsubtitle);
                                                ...
                                                if(allmatsplit1.length > 0)
                                                {
                                                 ...
                                                 {
                                                     var matcol = matcolarray[y].split("*");
                                                     resultstring+= '<td style="border: 1px solid #DCDCDC;text-align:center;"><input class="form-control formsize" type="text" value="' + matcol[0] + '" name="" id="rowcol'+matcol[1]+'" style="text-align:center;" onkeyup="changematname('+matcol[1]+')"></td>';
                                                ...
                                                {  
                                                    var matrow = matrowarray[x].split("*");
                                                    resultstring+= '<tr class="tabbord">';
                                                    resultstring+= '<td class="tabbord"><input class="form-control formsize" type="text" value="' + matrow[0] + '" name="" id="rowcol'+matrow[1]+'"  onkeyup="changematname('+matrow[1]+')"></td>';
                                                    for(var y=0;y<matcolarray.length;y++)
                                                    {
                                                        resultstring+= '<td class="tabbord" ><div id="setmatrixtype'+x+y+'"></div></td>';
                                                    }
                                        ...
                                        //alert("hkeel");
                                           // alert(data32.qsubtitle);
                                                ...
                                                if(allmatsplit1.length > 0)
                                                {
                                                 ...
                                                 {
                                                     var matcol = matcolarray[y].split("*");
                                                     resultstring+= '<td style="border: 1px solid #DCDCDC;text-align:center;"><input class="form-control formsize" placeholder="'+matcol[0]+'" type="text" value="' + matcol[0] + '" name="" id="rowcol'+matcol[1]+'" style="text-align:center;" onkeyup="changematname('+matcol[1]+')"></td>';
                                                ...
                                                {  
                                                    var matrow = matrowarray[x].split("*");
                                                    resultstring+= '<tr class="tabbord">';
                                                    resultstring+= '<td class="tabbord"><input class="form-control formsize" placeholder="'+matrow[0]+'" type="text" value="' + matrow[0] + '" name="" id="rowcol'+matrow[1]+'"  onkeyup="changematname('+matrow[1]+')"></td>';
                                                    for(var y=0;y<matcolarray.length;y++)
                                                    {
                                                        resultstring+= '<td class="tabbord" style="text-align:center;"><div id="setmatrixtype'+x+y+'"></div></td>';
                                                    }
                                                    resultstring+= '</tr>';
                                                }
...
<script>
$('#mrating_option_type').on('change', function()
{
    var mrating_option_val = this.value; //or alert($(this).val())
    if(mrating_option_val == "percentage")
    {
         $("#mrating-percentage").show();
    }
    else
    {
        $("#mrating-percentage").hide();
    }
    if(mrating_option_val == "textbox")
    {
        $("#mrating_scale").hide();
    }
    else{
    ...
    if(mrating_option_val == ""){
        $("#mratingtype_error_message_mrating").show();
    }
    else
    {
        $("#mratingtype_error_message_mrating").hide();
    }
});
</script>

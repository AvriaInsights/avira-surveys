    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header text-primary"><i class="fa fa-th-list"></i> Manage Pain Points</h3>
                        <ol class="breadcrumb">
                            <li><a href="index.php">Dashboard</a></li>
                            <li class="active">Manage Pain Points</li>
                        </ol>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <span class="pull-left">General Pain Points</span>
                            ...
                            <div>
                                <form action="delete-pain-points.php" method="post">
                                <!-- /.panel-heading -->
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#topic-data').dataTable({
                "bProcessing": true,
                "sAjaxSource": "load-pain-points.php",
                "aoColumns": [
                    {mData: 'pain_id'},
                    {mData: 'bundle_name'},
                    {mData: 'pain_name'}

...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header text-primary"><i class="fa fa-th-list"></i> Manage News List</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <span class="pull-left">General News List</span>
                            ...
                            <div>
                                <form action="delete_news_report.php" method="post">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#key-data').dataTable({
                "bProcessing": true,
                "sAjaxSource": "load-news-reports.php",
                "aoColumns": [
                    {mData: 'news_rep_id'},
                    {mData: 'bundle_name'},
                    {mData: 'title'},

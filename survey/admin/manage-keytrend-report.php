    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header text-primary"><i class="fa fa-th-list"></i> Manage KeyTrends List</h3>
                        <ol class="breadcrumb">
                            <li><a href="index.php">Dashboard</a></li>
                            <li class="active">Manage KeyTrends</li>
                        </ol>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <span class="pull-left">General KeyTrends List</span>
                            ...
                            <div>
                                ...
                                <div class="panel-body">
                                    <div class="dataTable_wrapper">
                                        <div>
                                            <form id="" action="delete-keytrend.php" method="post">
                                
                                            <table id="key-data" class="table table-striped table-bordered table-hover" width="100%" cellspacing="0">
                                                
                                                <thead>
                                                    <tr>
                                                        <th>#ID</th>
                                                        <th>Bundle Name</th>
                                                        <th>Keytrend Title </th>
                                                        <th>Impact</th>
                                                        <th>Direction</th>

            ...
            foreach ($csv_data as $key => $data) {
                ...
                if ($coloumn_count) {
                    ...
                    if (isset($title) && $title != "") {
                        $description = $obj_report->sanitizeOutput($data['Description']);
                        $meta_title = $obj_report->sanitizeOutput($title);
                        $meta_keywords = "";
                        $meta_description = "";
                        $toc = $obj_report->sanitizeOutput($data['TOC']);
                        $tnf = $obj_report->sanitizeOutput($data['LoF and LoT']);

                        $slug = $obj_report->removeSpace($title);
                        $condition = "`slug` = '" . $slug . "'";

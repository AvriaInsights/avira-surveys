...
//     define('SITETITLE', 'Researchandtrends');
//     define('SITEPATH', 'http://www.localhost/atr/');
//     define('SITEADMIN', 'http://www.localhost/atr/admin/');
//     define('SITEEMAIL', 'info@alltheresearch.com');
//     date_default_timezone_set("Asia/Kolkata");
//     define('LISTPERPAGE', 20);
// } else {
    define('DB_SERVER', '127.0.0.1');
    define('DB_USERNAME', 'soft4intent_AviraQA');
    define('DB_PASSWORD', ')Ric67ZYVoD2');
    define('DB_DATABASE', 'soft4intent_AviraQA');
    define('SITETITLE', 'AviraSurveys');
    define('SITEPATH', 'https://www.software-intent.com/survey/');
    define('SITEPATHFRONT', 'https://www.software-intent.com/');
    define('SITEADMIN','https://www.software-intent.com/survey/');
    define('SITEEMAIL', 'contact@software-intent.com');
    define('CRMSITEEMAIL', 'https://www.researchandtrends.com/ABMi-miniCRM/');
    date_default_timezone_set("Asia/Kolkata");
    define('LISTPERPAGE', 20);
//}

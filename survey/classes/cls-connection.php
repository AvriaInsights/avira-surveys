...
// } else {
    ...
    define('DB_USERNAME', 'aviras_surveys');
    define('DB_PASSWORD', 'A4bwK-^{rU~Y');
    define('DB_DATABASE', 'aviras_surveys');
    define('SITETITLE', 'AviraSurveys');
    define('SITEPATH', 'https://www.avirasurveys.com/survey/');
    define('SITEPATHFRONT', 'https://www.avirasurveys.com/');
    define('SITEADMIN','https://www.avirasurveys.com/survey/');
    define('SITEEMAIL', 'contact@avirasurveys.com');

...
class User extends Connection {
    ...
    // Registration Page Admin---
     ...
     public function insertAdminUser($insert_data, $debug = 0) {
        return $this->insertRow("tbl_client_user", $insert_data, $debug);
    }
    
    public function getUserclientDetails($fields = '', $condition = '', $order_by = '', $limit = '', $debug = 0) {
        return $this->getRecords('tbl_client_user', $fields, $condition, $order_by, $limit, $debug);
    }
    
    public function updateAdminUser($update_data, $condition = '', $debug = 0) {

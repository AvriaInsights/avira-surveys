...
//$fields_survey_result = " DISTINCT `tbl_response_user`.survey_id,`tbl_survey`.`survey_id`";
$fields_survey_result = "`tbl_survey`.survey_id,`tbl_survey`.`survey_id`";
        ...
        <li>Canvass
            <ul class="list-unstyled submenu-list">
                <li>
                    ...
                    <a href="<?php echo SITEPATH;?>dashboard/"><?php } else {?> <a href="<?php echo SITEPATH;?>dashboard/" onclick1="showactivesurvey();"> <?php }?>All Surveys 

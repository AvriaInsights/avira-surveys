                        ...
                        <div class="row d-flex align-items-center">
                                <div class="col-md-3">
                                 ...
                                 <div class="col-md-5">
                                    <div class="sm-menu-question-sub-header1" style="float:left;width:100%;">
                                        ...
                                        <form class="d-flex">
                                          <input class="form-control text-dark" type="search" placeholder="Search By Survey Title/Campaign Name" aria-label="Search" id="search-holder">
                                ...
                                <div class="col-md-4">
                                    <div class="sm-menu-question-sub-header1 d-flex justify-content-end">
                                        <ul class="nav nav-tabs status-menu border-0">Status :  <li class="active" style="color:#094cdc;">Active</li></ul>

                ...
                <div class="container" style="height:100vh;">
                    ...
                    <div id="mine">
                        <div class="row d-flex align-items-center">
                                ...
                                <div class="col-md-2">
                                    <div class="sm-menu-question-sub-header1">
                                        <a href="<?php echo SITEPATH ?>export-half-survey-result-by-user.php?surveyid=<?php echo $surveyid;?>"  class="exportlink" download><i class="fa fa-download fa-1x"></i> Export User Result</a>
                                    </div>
                                </div>
                                <!--<div class="col-md-6">-->

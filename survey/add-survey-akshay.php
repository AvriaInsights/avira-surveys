        ...
        <div class="modal-content">
          ...
          <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body">
                ...
                <form id="request-form" class="create-survey-module" action="<?php echo SITEPATH; ?>add-survey-title-action-test.php" method="post">
...
<script type="text/javascript">
 ...
 $(document).ready(function () {
     // ==== loader ======//
        ...
        $.ajax({
              url : "<?php echo SITEPATH;?>view-questions-demo.php",
              type : "POST",
        ...
        $("#editcurrentquestion").click(function(){
            ...
            /* if(currentqtypecheck == "mrating")
             {
                 ...
                 if(editnumItems != 0 || addnumItems != 0)
                      ...
                      {
                          $('#questionsubtitle_error_message_mrating').html("Please Enter Multiple Rating Options");
                          questionsubtitle_error_message = true;
           ...
           // alert(questionsubtitle_error_message);
            if(questiontitle_error_message === false && questionsubtitle_error_message === false)
            {
                var i=1;
                ...
                $.ajax({
                      ...
                      success: function(dataquestion){
                          //alert(dataquestion);
                            ...
                            $("#middlelabel").val("");
                            $("#rightlabel").val("");
                            $('input[name="mrating-range"]:checked').val("");

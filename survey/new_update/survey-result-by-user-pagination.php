...
{
    $condition_survey_result = "`tbl_response_user`.`status` = 'Active' and `tbl_survey`.`user_id` = '".$userid."' and `tbl_response_user`.`survey_id`='".$_GET['surveyid']."' and `tbl_response_user`.`survey_fill_position` = 'Full'";
}
else
{
    $condition_survey_result = "`tbl_response_user`.`status` = 'Active' and `tbl_survey`.`user_id` = '".$userid."' and `tbl_response_user`.`survey_fill_position`= 'Full'";
}

                             ...
                             <div id="allquestiontype">
                                    ...
                                    <?php $allquestiontype="";foreach($question_type_list as $question_type_lists){ ?>
                                          <div class="col-md-4 paddqtype1" style="cursor:pointer;" onclick="fetchquesttype('<?php echo $question_type_lists['quest_type'];?>','<?php echo $question_type_lists['quest_type_id'];?>')">
                                            <img class="qtype_icon" src="<?php echo SITEPATH; ?>images/qtype_icon/<?php echo $question_type_lists['quest_type']; ?>.png"> <span class="questyp" id="questyp<?php echo $question_type_lists['quest_type_id'];?>"><?php echo $question_type_lists['quest_type'];?></span>
                                                                    ...
                                                                    <div class="col-md-4">
                                                                      <div class="main-holder">
                                                                        <div class="form-group reqflt">
                                                                           <input type="checkbox" class="largerCheckbox" name="isrequired-boolean" 
                                                                           id="isrequired-boolean">
                                                            ...
                                                            <section id="options" class="tab-panel">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-8">
                                                                        <div class="main-holder">
                                                                            <div class="form-group">
                                                                               <input type="text" class="form-control formsize" 
                                                                               name="questiontooltip-rating" id="questiontooltip-rating"
                                                                               placeholder="Tooltip">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                      <div class="main-holder">
                                                                        <div class="form-group reqflt">
                                                                               <input type="checkbox" class="largerCheckbox" name="isrequired-rating" 
                                                                               id="isrequired-rating">
                                                                               <label class="form-label checklabel">Required</label>
                                                                            </div>
                                                                      </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                        <div class="col-md-8">
                                                                          <div class="main-holder">
                                                                                <div class="form-group">
                                                                                   <input type="text" class="form-control formsize"
                                                                                   name="questiontooltip-text" id="questiontooltip-text" placeholder="Tooltip">
                                                                                </div>
                                                                           </div>
                                                                        </div>
                                                                        <div class="col-md-4">
                                                                            <div class="main-holder">
                                                                                <div class="form-group reqflt">
                                                                                   <input type="checkbox" class="largerCheckbox" name="isrequired-text"
                                                                                   id="isrequired-text">
                                                                                   <label class="form-label checklabel">Required</label>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-8">
                                                                        <div class="main-holder">
                                                                            <div class="form-group">
                                                                               <input type="text" class="form-control formsize" 
                                                                               name="questiontooltip-opinion-scale" id="questiontooltip-opinion-scale"
                                                                               placeholder="Tooltip">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                      <div class="main-holder">
                                                                        <div class="form-group reqflt">
                                                                               <input type="checkbox" class="largerCheckbox" name="isrequired-opinion-scale" 
                                                                               id="isrequired-opinion-scale">
                                                                               <label class="form-label checklabel">Required</label>
                                                                            </div>
                                                                      </div>
                                                                    </div>
 ...
 $(document).ready(function () {
        ...
        $("#editcurrentquestion").click(function(){
            ...
            $.ajax({
                  ...
                  url : currurl,
                  type : "POST",
                  data : {questiontitle:questiontitle,questiontooltip:questiontooltip,isrequired:isrequired,updquestid:updquestid,singleqtype:singleqtype,texttype:texttype,checkboxoptions:checkboxoptions,radoptions:radoptions,dropdownval:dropdownval,other:other,mintext:mintext,midtext:midtext,maxtext:maxtext},
                  success: function(dataquestion){
                      //alert(dataquestion);
                        $("#questiontitle").val("");
                        $("#questiontooltip").val("");

...
if(isset($_GET['surveyid']))
{
    ...
    $fields_questions = "`tbl_questionBank`.`question_title`,`tbl_question_type`.`quest_type`";
    ...
    foreach($survey_respose_users as $survey_respose_user)
    {
        ...
        $condition_survey_result_ans = "`tbl_response_result`.`response_user_id` = '".$survey_respose_user['response_user_id']."'";
        ...
        foreach($all_result_surveys_anss as $all_result_surveys_ans)
        {
              ...
              $condition_survey_result_ans1 = "`tbl_response_result`.`response_user_id` = '".$survey_respose_user['response_user_id']."' and `tbl_response_result`.`question_id` = '".$all_result_surveys_ans['question_id']."'";

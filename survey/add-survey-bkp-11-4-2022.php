                                                                    ...
                                                                    <div class="row pt-1">
                                                                         <div class="col-md-4">
                                                                                <div class="form-group float-start mt-3 font-weight-normal">
                                                                                   <p class="fs-4">Select Rating Range Option : </p>
                                                                                </div>
                                                                            </div>
                                                                          <div class="col-md-2">
     ...
     // ==== loader ======//
        ...
        $("#editcurrentquestion").click(function(){
            ...
            if(questiontitle_error_message === false && questionsubtitle_error_message === false && matrix_error_message === false)
            {
                ...
                var mrating_range = $('input[name="mrating-range"]:checked').val();
                                        ...
                                        //alert("hello");
                                          //  alert(data32.qsubtitle);
                                                ...
                                                if(allmatsplit1.length > 0)
                                                {
                                                 ...
                                                 resultstring+= '<tr class="tabbord" style="background-color:#F5F5F5;">';
                                                 resultstring+= '<td class="tabbord"></td>';
                                                 for(var y=0;y<matcolarray.length;y++)
                                                 {
                                                     var matcol = matcolarray[y].split("*");
                                                     resultstring+= '<td class="tabbord"><input class="form-control formsize matrix-tbl-input" placeholder="' + matcol[0] + '" type="text" value="" name="" id="rowcol'+matcol[1]+'" style="text-align:center;background-color:#F5F5F5;" onkeyup="changematname('+matcol[1]+')"></td>';
                                                ...
                                                {  
                                                    ...
                                                    resultstring+= '<td class="tabbord"><input class="form-control formsize matrix-tbl-input" placeholder="' + matrow[0] + '" type="text" value="" name="" id="rowcol'+matrow[1]+'" style="text-align:center;" onkeyup="changematname('+matrow[1]+')"></td>';
                                                    for(var y=0;y<matcolarray.length;y++)
                                                    {
                                        ...
                                        //alert("hkeel");
                                           // alert(data32.qsubtitle);
                                                ...
                                                if(allmatsplit1.length > 0)
                                                {
                                                 ...
                                                 resultstring+= '<tr class="tabbord">';
                                                 resultstring+= '<td class="tabbord" style="background-color:#F5F5F5;"></td>';
                                                 for(var y=0;y<matcolarray.length;y++)
                                                 {
                                                     var matcol = matcolarray[y].split("*");
                                                ...
                                                {  
                                                    var matrow = matrowarray[x].split("*");
                                                    resultstring+= '<tr class="tabbord">';
                                                    resultstring+= '<td class="tabbord"><input class="form-control formsize" type="text" value="' + matrow[0] + '" name="" id="rowcol'+matrow[1]+'" style="text-align:center;" onkeyup="changematname('+matrow[1]+')"></td>';
                                                    for(var y=0;y<matcolarray.length;y++)
                                                    {
                                                        resultstring+= '<td class="tabbord" style="text-align:center;"><div id="setmatrixtype'+x+y+'"></div></td>';
                                                    }

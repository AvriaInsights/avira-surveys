        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1 align-items-start">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <h4 class="mb-0 pt-3 fw-bold" id="outof" style="display:none;">(<span id="curqnodisp"></span>/<span id="totalquestiondisp"></span>)</h4>
                </div>
                        ...
                        <div class="common-que-header">
                            <div class="align-txt">
                                ...
                                <div class="tooltip">
                                    ...
                                    <span data-tooltip="<?php echo $replace_tooltip; ?>" data-tooltip-position="left">
...
var orderids=[];
   $(document).ready(function(){
           ...
           $("#totalquestiondisp").text("<?php echo $totalquest?>");
           $("#outof").show();
           //$("#curqnodisp").text("1");

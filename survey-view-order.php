                                       ...
                                       <div class="chk_class">
            				                     <div class="row pb-5">
                                                    ...
                                                    <div class="col-md-12 mt-2 mb-4">
                                                        <div class="button" id="btn_next_check" onclick="setnext(<?php echo $srno;?>,<?php echo $all_subpoint['question_subid'];?>,<?php echo $all_question['question_id'];?>,'');">
                                                         <div id="slide" class="slide"></div>
                                ...
                                <?php if ($all_question['quest_type_id'] == "8") { ?> 
                                  <div id="que_<?php echo $srno;?>" style="display:none" class="que_scroll item mt-1 mb-3" data-id='<?php echo $srno;?>'  isAttempted="0">
                                    ...
                                    <?php $counter=0; foreach($all_subpoints as $all_subpoint){ $counter++;?>
                                          ...
                                          <div class="col-md-2">
                                              <div class="star" id="seq_error_message"></div> 

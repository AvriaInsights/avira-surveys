...
// } else {
    ...
    define('DB_USERNAME', 'soft4intent_expertinsights');
    define('DB_PASSWORD', 'n@G8~S_f1E)a');
    define('DB_DATABASE', 'soft4intent_expertinsights');
    define('SITETITLE', 'Expert Insights');
    define('SITEPATH', 'https://software-intent.com/expert-insights/');
    define('SITEADMIN','https://software-intent.com/expert-insights/admin');
    define('SITEEMAIL', 'sales@researchandtrends.com');
    date_default_timezone_set("Asia/Kolkata");
    define('LISTPERPAGE', 20);
//}

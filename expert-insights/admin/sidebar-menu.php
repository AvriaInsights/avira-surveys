...
$explodepgname=explode("/ABMi-miniCRM/",$pageurl);
//$pagename=trim($explodepgname[1],".php");
//$pg1=ucwords(str_replace("-", " ",$pagename));


$pagenameclass12="nav-links-".str_replace(array('/',' '),"-",$explodepgname[1]);

//echo $pagenameclass12; die();
...
<?php }?>
<div class="sidebar" id="sidebar_set">
    <div class="logo-details">
      <!--<i class='bx bxl-bitcoin'></i>-->
      <a href="<?php echo SITEADMIN;?>dashboard"><img src="<?php echo SITEADMIN;?>images/Avira Favicon_W.svg" class="img-fluid top-left-icon small-icon mt-3" id="favimg"></a>
      <span class="logo_name" id="bigimg">
          <a href="<?php echo SITEADMIN;?>dashboard"><img src="<?php echo SITEADMIN;?>images/AviraLead_light_logo.svg" class="img-fluid c_logo"></a>
      </span>
    </div>
    <ul class="nav-links">
        <li id="nav-links-dashboard">
        ...
        <li id="nav-links-<?php echo trim($menu_detail['menu_htaccess_url']);?>">
            <div class="icon-links">
              <a <?php if(empty($sub_menu_details)) { ?> href="<?php echo SITEADMIN.$menu_detail['menu_htaccess_url'];?>" <?php }?>>
                <i class='<?php echo $menu_detail['menu_icon_url'];?>'></i>
...
$(document).ready(function(){
  var pg = '<?php echo $pagenameclass12;?>';
  //alert(pg);

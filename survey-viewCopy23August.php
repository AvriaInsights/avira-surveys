                 ...
                 <div class="row">
                    <div class="col-md-12 temp-img">
                         <div class="br-25 bannar" style="background-image:url('<?php echo SITEPATH; ?><?php echo $template_image;?>')">
                             <div class="row"><h1 class="text-white first_survey_heading fixed-ttl" style="display:none;" id="sqtitle"><?php echo $survey_title;?></h1></div>
                            ...
                            <div class="row">
                                    <div class="col-md-8 offset-md-2 text-center mt-5 mb-5 p-3" id="temp_section">
          ...
          <form class="create-survey-module" action="<?php echo SITEPATHFRONT; ?>survey-close-feedback.php" method="post">
              ...
              <div class="col-md-12 item wrapper1">
                  ...
                  <?php $i=1;foreach($feedbacks as $feedback){?>
                   ...
                   <p> <input type="radio" id="optionfed-<?php echo $i;?>" name="fedradio" value="<?php echo $feedback['feed_id'];?>" class="" <?php if($feedback['feed_id']==1){?> checked <?php }?>>
                ...
                <div class="button sub-btn mt-5" id="closefeedbacksubmit" style="width:100%;">

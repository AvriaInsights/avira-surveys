...
$(document).ready(function(){
        ...
        // Ranking Questions Type
            ...
            if(ranking_scroll >= 7)
            {
                $('.sub_points_rank').css('height','200px');
        ...
        // Dropdown Questions Type
            ...
            if(dropdown_scroll >= 7)
            {
                $('.dropdown-list').css('height','200px');
...
<script>
    $(document).ready(function(){
        $(document).load($(window).bind("resize", checkPosition()));
            ...
            {
                if($(window).width() <=410 || $(window).width() <=430)
                {
                    $('.sub_points_rank').attr('style', 'height: 400px !important');
                    $('.radio-scroll-vt').css( 'height','70rem');
                    // $('.rank_ord').attr('style', 'display:none');
                }

                             ...
                             ?>
                                ...
                                <?php if($all_question['quest_type_id'] == "2") {  ?> 
                                   ...
                                   <div class="toolt">
                                    ...
                                    <input type="hidden" name="required_<?php echo $srno;?>" id="required_<?php echo $srno;?>" value="<?php echo $all_question['is_required'];?>">
                                     <input type="hidden" name="skip_from_<?php echo $srno;?>" id="skip_from_<?php echo $srno;?>" value="<?php echo $all_question['skip_from_which_question'];?>">
                                      <div class="col-12 pb-5 sub_points_down" id="sub_scrollbar_diff">
                					    ...
                					    <?php $counter = 0; foreach($all_subpoints as $all_subpoint){ $counter++; ?>
                    						...
                    						<label class="for-checkbox-tools radio-check-box for_radio_label_charcount" for="radiotype_<?php echo $all_subpoint['question_subid'];?>">
                    							<p class="survey-txt"><?php echo $all_subpoint['question_subtitle'];?></p>
                    						</label>
                    						
                    							<input type="hidden" value="<?php echo strlen($all_subpoint['question_subtitle']);?>" id="rdo_sub_char_count_<?php echo $counter; ?>" name="rdo_sub_char_count">
                    					<?php } ?>
                		        ...
                		        <?php if ($all_question['quest_type_id'] == "3") { ?>
				                 <div id="que_<?php echo $srno;?>" style="display:none" class="que_scroll item mt-1" data-id='<?php echo $srno;?>' isAttempted="0">
                                    ...
                                    <input type="hidden" name="chkselectedval_<?php echo $all_question['question_id'];?>" id="chkselectedval_<?php echo $all_question['question_id'];?>" value="">  
                                     <input type="hidden" name="skip_from_<?php echo $srno;?>" id="skip_from_<?php echo $srno;?>" value="<?php echo $all_question['skip_from_which_question'];?>">
                                       <div class="chk_class">
            				                     <div class="row pb-5 sub_points_down_chk" id="sub_scrollbar_diff">
            				                        <?php $counter = 0; foreach($all_subpoints as $all_subpoint){ $counter++; ?>
                                                     <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 mt-2 mb-4">
                                                            <div class="button next-btn-q" id="btn_next_check" onclick="setnext(<?php echo $srno;?>,<?php echo $all_subpoint['question_subid'];?>,<?php echo $all_question['question_id'];?>,'');">
                                                             <div id="slide" class="slide"></div>
                                                              <a href="javascript:void(0);" class="action-btn-disabled " id="btn_next_other_check_<?php echo $all_question['question_id'];?>">NEXT &nbsp;&nbsp;<i class="fa fa-angle-right"></i></a>
   ...
   //alert(subtitle);
     ...
     //alert(seq);
        ...
        else
        {
            ...
            {//alert(allsubidsplit[tt]);
                if(allsubidsplit[tt]!=subqueid && thisOptionValue!="")
                { 
                  var opt = $("#order_"+allsubidsplit[tt]+" option[value='" + thisOptionValue + "']"); 
...
$(document).ready(function(){
       ...
       /* else
        {
          $('.sub_points_down').css({"height":"auto"});   
        }*/
});
</script>
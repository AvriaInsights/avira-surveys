...
$page = "home";
$page_title = "Global Market Surveys | Privacy Policy - " . SITETITLE;
...
<section class="bg-img">
    <div class="container">
        <div class="row pt-5">
            <div class="card-back shadow-lg p-3 col-md-10 offset-md-1">
                <div class="ScrollStyle" id="style-5">
                    <div class="force-overflow">
                        <div class="container">
                            <div class="row d-flex text-center">
                               <!-- <div class="col-md-2 d-flex">
                                    <img class="company_logo" src="images/logo-light.png">
                                </div>-->
                                <div class="col-md-8 offset-md-2 text-center">
                                    <h1 class="privacy-text pt-5 mb-5">Privacy Policy</h1>
                                </div>
                            </div>
                        </div>

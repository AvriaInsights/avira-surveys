...
$update_data1['survey_fill_position'] = "Approximately";
        ...
        for($t=0;$t<count($staranswer);$t++)
        {
            if(strpos($staranswer[$t], "◘") !== false)
            {
                ...
                $rankansweradd=$rankanswer[1];
                    ...
                    $insert_data1['survey_fill_position'] = "Approximately";
            ...
            if($qtypep=="Matrix")
            {
                ...
                $insert_data2['survey_fill_position'] = "Approximately";

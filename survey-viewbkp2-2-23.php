...
if(isset($_GET['name']) || isset($_GET['email']) || isset($_GET['company']))
{
        ...
        $insert_data22['domain'] = "SoftIntent";
    ...
    <div class="container-fluid pb-5">
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1 align-items-start">
                <div>
                    <h4 class="note-txt">Your data and responses are safe with us. Privacy is our business!</h4>
                </div>
                ...
                <div class="option-holder que_section" id="divQstn">
                    ...
                    <div class="item" id="que_<?php echo $srno;?>" data-id="<?php echo $srno;?>" style="display:none;">
                        ...
                        <div class="bg-shadow space-all text-center">
                            ...
                            <input type="hidden" name="url_fname" id="url_company" value="<?php echo $_GET['company']; ?>">
                            <input type="hidden" name="url_fname" id="url_designation" value="<?php echo $_GET['url_designation']; ?>">
      ...
      <div class="modal-body">
          <!--<h5 class="thanks-head feedbackh5 fs-2 p-3" id="exampleModalLongTitle"></h5>-->
              ...
              <div class="col-md-12 item wrapper1" style="font-size:18px;">
                  ...
                  The survey is nearing completion. Your every input will be valuable in shaping the outcomes involving the market dynamics. Click continue to finish the survey.
                <div class="button sub-btn mt-0 text-center" id="closemessageoncrosssubmit" style="width:100%;padding-top:20px;">
                    <button type="button" class="cta-btn btn m-0" id="" data-bs-dismiss="modal" aria-label="Close">Continue</button>

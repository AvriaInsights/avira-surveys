...
/* Tooltip styling */
    ...
    @media only screen and (min-device-width: 480px) and (max-device-width: 550px)and (-webkit-min-device-pixel-ratio: 2) {
        ...
        .number-holder,.left-side-pattern,
        .right-side-pattern{
            display:none;
        }
    }
...
<body>
    ...
    <div class="container-fluid mid-align">
        ...
        <div class="row height-overflow-auto" id="sub_scrollbar_diff">
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1 align-middle-content-1">
                <h4 class="first_survey_heading main-que-ttl mb-0" style="display:none;" id="sqtitle">
                    ...
                    <?php }else { ?><span><?php echo $survey_title;?></span><?php }?>
                    <?php } else {?>
                    ...
                    <div class="col-md-12">
                        <div class="row align-items-center justify-content-center" id="btn_slider" style="display:none;">
                            <div class="col-lg-7 col-md-5">
                                <?php if(isset($footer_tagline) && $footer_tagline!=""){ ?>
                                 <p class="para mb-0 off-txt" title="<?php echo 'Complete the survey to download $4000 worth of '.$footer_tagline; ?>"> 
                                 Complete the survey to download $4000 worth of 
                                 <?php 
                                    if(strlen($footer_tagline)>=95){echo substr($footer_tagline,0,95)."..."; } 
                                    else { echo $footer_tagline;} 
                                 ?> 
                                 </p>
